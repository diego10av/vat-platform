...
>
> Last updated: 2026-04-24 — Stint 34: `/tax-ops` module shipped
> in 6 commits (A-F). Replaces Diego's two annual Excels (148 +
> 83 entities) + his Notion "Tasks & Follow-ups" DB with a live
> Postgres-backed compliance tracker: state-machine filings,
> editable deadline rules with propagation, year-rollover in one
> click, tasks with subtasks/deps/recurring/comments, daily
> deadline-alerts cron, Ask-cifra tax-ops tools. 214 entities ·
> 263 filings · 13 deadline rules seeded in prod. Previously:
> CRM Fases 1-5 shipped stints 26-31.
