      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            {/* Stint 95 — DraftEmailButton "Draft chase" removed. Diego
                has no Outlook integration; the AI-drafted body had to
                be copy-pasted, never used in practice. The plain
                "Open in mail client" mailto button above (line ~200)
                still provides the manual chase path. */}
